...
public class Ex1FoodMysqlDb extends JFrame{
	...
	JButton btnFoodResAdd,btnFoodResDel; //버튼 2개
	JButton btnFoodOrderAdd,btnFoodOrderDel; //버튼 2개
	
	JTextField tfFoodNum,tfOrderName,tfOrderCnt,tfBookingDay; //입력
	JTextField tfFoodName,tfFoodPrice,tfFoodSize;
	
	//생성자
	public Ex1FoodMysqlDb() {
		// TODO Auto-generated constructor stub
		super("메뉴등록 및 예약"); // 프레임 제목
		this.setBounds(200, 100, 1000, 400);  // 프레임 크기
		this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // x 누르면 종료
		this.initDesign(); // initDesign 호출
		this.setVisible(true); // 프레임 호출
	}
	...
	//조인
	public void writeFoodOrderJion() {
		//order 데이타 가져오기
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Ex1FoodMysqlDb ex1=new Ex1FoodMysqlDb(); //생성자
