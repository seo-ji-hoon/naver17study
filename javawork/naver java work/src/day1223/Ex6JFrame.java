...
class MyFrame extends JFrame {
	//멤버변수로 버튼을 생성
	JButton btn1=new JButton("OneButton");//버튼 제목생성
	...
	public MyFrame() {
		...
		this.setVisible(true); // true 프레임이 보인다. ->false 는 프레임을 숨긴다.
		
		//아래 메서드가 없을경우 x를 눌러서 프레임을 닫으면 그냥 프레임 숨김만 된다.(console이 계속 실행)		
